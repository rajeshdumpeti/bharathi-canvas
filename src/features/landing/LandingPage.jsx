        ...
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center">
            ...
            <div className="flex flex-1 flex-col p-4 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                    ...
                    {/* Personal Documents */}
                    <div className="p-8 bg-white rounded-xl shadow-xl transform hover:scale-[1.01] transition-transform duration-300">
                        <h2 className="text-2xl font-semibold mb-2">Your Personal Documents</h2>
                        <p className="text-sm text-gray-500 mb-6">Upload, organize and preview PDFs, DOCX, and TXT files.</p>
                        <button
                            onClick={onStartDocs}
