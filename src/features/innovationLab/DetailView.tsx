...
import SpecComposer from "./components/SpecComposer";
  ...
  return (
    <div className="h-full w-full">
      <div className="mx-auto w-full max-w-5xl p-4 space-y-4">
        ...
        {/* Milestones / lightweight roadmap */}
        <div className="rounded-lg border bg-white p-4">
          <h3 className="font-semibold mb-2">Milestones</h3>
          <Milestones
            value={idea.milestones}
            onChange={(next) => patch("milestones", next)}
          />
        </div>
        {/* Spec Composer (read-only outline) */}
        <div className="rounded-lg border bg-white p-4">
          <h3 className="font-semibold mb-2">Spec Composer</h3>
          <SpecComposer idea={idea} />
        </div>
        {/* footer tip */}
